...
pub mod encoding {
    ...
    pub mod place {
        ...
        mod disabled {
            ...
            #[inline(always)]
            pub const fn decode_ref<P, D>(ref_value: PlaceRef) -> Option<P> {
                None
            }
        }
        #[cfg(not(refs_inlining))]
    ...
    pub mod operand {
        ...
        mod default {
            ...
            const OPERAND_CONST_SOME: Ref =
                INLINED_FLAG | OPERAND_CONST_FLAG | OPERAND_CONST_TYPE_SOME;
            ...
            #[inline]
            pub fn decode_ref<O, D: OperandRefInlinedDecoder<O>>(
                ref_value: OperandRef,
            ) -> Option<O> {
                if !is_inlined(ref_value) {
                    None
        ...
        mod disabled {
            ...
            #[inline(always)]
            pub const fn decode_ref<O, D>(ref_value: OperandRef) -> Option<O> {
                None
            }
        }
        #[cfg(not(refs_inlining))]
