...
use super::node::*;
use common::types::trace::{Constraint, ConstraintKind};
    ...
    I: Eq + Hash,
{
    ...
    ) -> crate::solver::SolveResult<HashMap<I, AstNode<'ctx>>> {
    ...
    fn check_using(
        ...
        let result = match solver.check() {
            SatResult::Sat => {
                ...
                crate::solver::SolveResult::Sat(values)
            }
            SatResult::Unsat => crate::solver::SolveResult::Unsat,
            SatResult::Unknown => crate::solver::SolveResult::Unknown,
        };
